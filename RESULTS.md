...
| lot | CNN on resized 64x64 (BatchNorm) | erm/poolmean | ema | 0.8587 | 0.8560 | -0.0027 |
| lot | CNN on resized 64x64 (BatchNorm) | erm/poolmeanmax | ema | 0.8798 | 0.8812 | +0.0014 |
| lot | CNN on resized 64x64 (BatchNorm) | erm/poolmeanmean | ema | 0.8615 | 0.8624 | +0.0009 |
...
| lot_time | CNN + RPCA lot-signature channel | erm/rpca2_zeros | ema | 0.6958 | 0.7035 | +0.0078 |
...
| lot | CNN on resized 64x64 (BatchNorm) | poolmean | 0.8587 | -0.0000 | 0.4898 | +0.0000 |
| lot | CNN on resized 64x64 (BatchNorm) | poolmeanmax | 0.8798 | +0.0211 | 0.5000 | +0.0102 |
| lot | CNN on resized 64x64 (BatchNorm) | poolmeanmean | 0.8615 | +0.0027 | 0.4898 | +0.0000 |
...
| lot_time | CNN + RPCA lot-signature channel | rpca2_zeros | 0.6958 | -0.0062 | 0.4898 | +0.0000 |
...
|---|---|---|---|---|---|---|---|
| iid | CNN on resized 64x64 (BatchNorm) | erm | poolmean | 4 | 0.8641 | +/-0.0074 | 0.8640, 0.8708, 0.8559, 0.8655 |
| iid | CNN on resized 64x64 (BatchNorm) | erm | poolmeanmax | 4 | 0.8867 | +/-0.0078 | 0.8790, 0.8945, 0.8804, 0.8931 |
| iid | CNN on resized 64x64 (BatchNorm) | erm | poolmeanmean | 4 | 0.8629 | +/-0.0041 | 0.8618, 0.8641, 0.8587, 0.8669 |
...
| lot | CNN + RPCA lot-signature channel | erm | rpca2_failmask | 8 | 0.8764 | +/-0.0163 | 0.8771, 0.8709, 0.8657, 0.8815, 0.8921, 0.8595, 0.8750, 0.8895 |
| lot | CNN + RPCA lot-signature channel | erm | rpca2_residual | 8 | 0.8745 | +/-0.0114 | 0.8826, 0.8631, 0.8647, 0.8709, 0.8859, 0.8705, 0.8763, 0.8819 |
| lot | CNN + RPCA lot-signature channel | erm | rpca2_zeros | 8 | 0.8765 | +/-0.0147 | 0.8720, 0.8694, 0.8591, 0.8773, 0.8886, 0.8761, 0.8808, 0.8883 |
...
| lot_time | CNN on resized 64x64 (BatchNorm) | erm | poolmean | 4 | 0.6565 | +/-0.0126 | 0.6692, 0.6501, 0.6626, 0.6440 |
| lot_time | CNN on resized 64x64 (BatchNorm) | erm | poolmeanmax | 3 | 0.6775 | +/-0.0347 | 0.6956, 0.6338, 0.7032 |
| lot_time | CNN on resized 64x64 (BatchNorm) | erm | poolmeanmean | 3 | 0.6418 | +/-0.0047 | 0.6392, 0.6479, 0.6384 |
...
| size | CNN on resized 64x64 (BatchNorm) | erm | poolmean | 8 | 0.7942 | +/-0.0486 | 0.7670, 0.7601, 0.8352, 0.7403, 0.8375, 0.7603, 0.8359, 0.8170 |
| size | CNN on resized 64x64 (BatchNorm) | erm | poolmeanmax | 8 | 0.8244 | +/-0.0540 | 0.8013, 0.7570, 0.8457, 0.7914, 0.8650, 0.8273, 0.8615, 0.8459 |
| size | CNN on resized 64x64 (BatchNorm) | erm | poolmeanmean | 8 | 0.7989 | +/-0.0463 | 0.7731, 0.7510, 0.8203, 0.7811, 0.8436, 0.7743, 0.8365, 0.8110 |
...
| size | CNN on resized 64x64 (GroupNorm) | erm | poolmeanmean | 8 | 0.8467 | +/-0.0392 | 0.8318, 0.8190, 0.8770, 0.8078, 0.8756, 0.8183, 0.8862, 0.8581 |
...
| lot | CNN on resized 64x64 (BatchNorm) | erm/poolmean | 0.8587 | 0.8455 | 0.8448 | +0.0007 | 8 | 43,121 | 131 |
| lot | CNN on resized 64x64 (BatchNorm) | erm/poolmeanmax | 0.8798 | 0.8712 | 0.8896 | -0.0184 | 8 | 43,121 | 131 |
| lot | CNN on resized 64x64 (BatchNorm) | erm/poolmeanmean | 0.8615 | 0.8474 | 0.8200 | +0.0274 | 8 | 43,121 | 131 |
...
| lot_time | CNN + RPCA lot-signature channel | erm/rpca2_zeros | 0.6958 | 0.7036 | 0.7537 | -0.0501 | 8 | 35,607 | 7,630 |
