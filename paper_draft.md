...
| `lot` | CNN (GroupNorm) | `focal` | focal0.0 | 6 | 0.8726 | ±0.0129 |
| `lot` | CNN (GroupNorm) | `focal` | focal0.5 | 2 | 0.8759 | ±0.0001 |
| `lot` | CNN (GroupNorm) | `focal` | focal1.0 | 2 | 0.8729 | ±0.0019 |
| `lot` | CNN (GroupNorm) | `focal` | focal2.0 | 5 | 0.8729 | ±0.0115 |
...
| `lot` | CNN + 4th channel | `erm` | rpca2_failmask | 6 | 0.8745 | ±0.0163 |
| `lot` | CNN + 4th channel | `erm` | rpca2_residual | 6 | 0.8729 | ±0.0114 |
| `lot` | CNN + 4th channel | `erm` | rpca2_zeros | 6 | 0.8738 | ±0.0147 |
